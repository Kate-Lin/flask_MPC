...
class Poly:
    ...
    def add(self, poly, coeff_modulus=None):
        ...
        poly_sum = Poly(self.ring_degree, [0] * self.ring_degree)
    ...
    def subtract(self, poly, coeff_modulus=None):
        ...
        poly_diff = Poly(self.ring_degree, [0] * self.ring_degree)
    ...
    def multiply(self, poly, coeff_modulus, ntt=None, crt=None):
        ...
        if ntt:
            ...
            prod = ntt.ftt_inv(ab)
            return Poly(self.ring_degree, prod)
    ...
    def multiply_crt(self, poly, crt):
        ...
        return Poly(self.ring_degree, final_coeffs).mod_small(crt.modulus)
    ...
    def multiply_naive(self, poly, coeff_modulus=None):
        ...
        poly_prod = Poly(self.ring_degree,
                               [0] * self.ring_degree)
    ...
    def scalar_multiply(self, scalar, coeff_modulus=None):
        ...
        return Poly(self.ring_degree, new_coeffs)
    ...
    def base_decompose(self, base, num_levels):
        ...
        Returns:
            ...
            the base T^i.
        """
        decomposed = [Poly(self.ring_degree, [0] * self.ring_degree) for _ in range(num_levels)]
        poly = self
